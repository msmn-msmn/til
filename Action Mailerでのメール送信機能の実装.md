...
メール送信時の デフォルト送信者アドレス を指定。<br>
UserMailer など各メールクラスで default を上書きしなければ、こちらのアドレスが適用されます 。<br>

🛠 layout 'mailer'<br>
app/views/layouts/mailer.html.erb／.text.erb に記載された <br>
共通のヘッダー・フッター等の構造やスタイル がメールの各ビューに適用されます。<br>
Webアプリの ApplicationController と application.html.erb の関係と同じ役割です。<br>
